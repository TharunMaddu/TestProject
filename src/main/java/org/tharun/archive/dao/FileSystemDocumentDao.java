package org.tharun.archive.dao;
...
import org.tharun.archive.service.Document;
import org.tharun.archive.service.DocumentMetadata;
 ...
 * 
 * @author Tharun <tharunmaddu[at]gmail[dot]com>
 */
@Service("documentDao")
public class FileSystemDocumentDao implements IDocumentDao {
     ...
     * 
     * @see org.tharun.archive.dao.IDocumentDao#insert(org.tharun.archive.service.Document)
     */
    @Override
     ...
     * the parameter.
     * 
     * @see org.tharun.archive.dao.IDocumentDao#findByPersonNameDate(java.lang.String, java.util.Date)
     */
    @Override
     ...
     * 
     * @see org.tharun.archive.dao.IDocumentDao#load(java.lang.String)
     */
    @Override
